...
GAPSIZE = 10 #gaps between columns/rows
...
def main():
    ...
    mousex = 0 #used for x mouse position
    mousey = 0 #used for y mouse position

    pygame.display.set_caption('Memory Game')
    topText = myFont.render("Made by JJ", 1,TEXTCOLOR)

    mainBoard = getRandomizedBoard()
    revealedBoxes = generateRevealedBoxesData(False)

    firstSelection  = None #stores x and y of first box clicked
